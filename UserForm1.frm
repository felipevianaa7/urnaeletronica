...
Private Sub bt0_Click()
    ...
    For i = 2 To iLinha
        cdNome = ""
        Image1.Picture = LoadPicture("C:\Users\Usuário\Documents\Projeto Urna Eletônica\Imagens\oculto.bmp")
        If cdNumero = Planilha1.Cells(i, 1) Then
            cdNome = Planilha1.Cells(i, 2)
            Image1.Picture = LoadPicture("C:\Users\Usuário\Documents\Projeto Urna Eletônica\Imagens\" & cdNome & ".jpg")
            Exit Sub
        End If
    Next i
End Sub
